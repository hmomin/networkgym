...
python -u NetworkAgent/config_changer.py --train --agent DDPG --seed 0 --steps 2
...
echo "Training SAC"
python -u NetworkAgent/config_changer.py --train --parallel_env --agent SAC --seed 0 --steps 102400
cd NetworkAgent/stable-baselines3
python -u main_rl.py --env nqos_split --client_id 0
cd ../..